...
-export([navstar_rest_dns_get_test/1, navstar_rest_dns_post_test/1, navstar_rest_dns_modify_test/1]).
...
all() -> [navstar_rest_dns_get_test, navstar_rest_dns_post_test, navstar_rest_dns_modify_test].
