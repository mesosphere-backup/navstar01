...
test_ipvs_mgr(_Config) ->
    ...
    "" = os:cmd("ipvsadm -C"),
    [] =  navstar_l4lb_ipvs_mgr:get_services(Pid, host),
    false = has_vip({4, 4, 4, 4}, 80),
    ok = navstar_l4lb_ipvs_mgr:add_service(Pid, {4, 4, 4, 4}, 80, tcp, host),
