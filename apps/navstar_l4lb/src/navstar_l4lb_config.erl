...
cni_dir() ->
  application:get_env(navstar_l4lb, cni_dir, "/var/run/dcos/cni/l4lb").
...
min_named_ip6() ->
  application:get_env(navstar_l4lb, min_named_ip6, {16#fd01,16#c,16#0,16#0,16#0,16#0,16#0,16#0}).

max_named_ip6() ->
  application:get_env(navstar_l4lb, max_named_ip6, {16#fd01,16#c,16#0,16#0,16#ffff,16#ffff,16#ffff,16#ffff}).
