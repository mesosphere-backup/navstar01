...
applying_first_config(internal, 
    ...
    navstar_overlay_configure:start_link(reply, Event),
    keep_state_and_data;
applying_first_config(info, {navstar_overlay_configure, applied_config}, Data) ->
...
configuring(internal, {lashup_kv_events, Event = #{key := [navstar, overlay, Subnet], ref := Ref}},
    ...
    Pid = navstar_overlay_configure:start_link(noreply, Event),
...
configuring(info, _EventContent, Data) ->
    ...
    navstar_overlay_configure:stop(Data#data.pid),
