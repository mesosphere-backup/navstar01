...
test_ip_cmds(Config) ->
    ...
    {ok, _} = navstar_overlay_netlink:ipneigh_replace(Pid, IP, Mac, ?IFNAME),
...
test_iprule_cmds(Config) ->
    ...
    Src = {9,0,0,0}, 
    SrcPrefixLen = 8,
    {ok, _} = navstar_overlay_netlink:iprule_add(Pid, Src, SrcPrefixLen, 42),
    ...
    Rule = navstar_overlay_netlink:make_iprule(Src, SrcPrefixLen, 42),
