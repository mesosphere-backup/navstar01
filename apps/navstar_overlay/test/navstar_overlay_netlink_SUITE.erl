...
test_iplink_add(Config) ->
    ...
    {ok, _} = navstar_overlay_netlink:iplink_add(Pid, ?IFNAME, "vxlan", 1024, 64000),
...
test_ipneigh_replace(Config) ->
    ...
    {ok, _} = navstar_overlay_netlink:ipneigh_replace(Pid, DstIP, DstMac, ?IFNAME),
...
test_iproute_replace(Config) ->
    ...
    DstIP = {192,168,65,91},
    SrcIP = {44,128,0,1},
    {ok, _} = navstar_overlay_netlink:iproute_replace(Pid, DstIP, 32, SrcIP, 42),
